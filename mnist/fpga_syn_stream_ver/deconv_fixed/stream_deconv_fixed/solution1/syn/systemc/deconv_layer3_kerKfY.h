...
#ifndef _deconv_layer3_kerKfY_H_
#define _deconv_layer3_kerKfY_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "deconv_layer3_kerKfY_memcore.h"

SC_MODULE(deconv_layer3_kerKfY) {
...
protected:
    ...
    deconv_layer3_kerKfY_memcore* deconv_layer3_kerKfY_memcore_U;
...
public:
    ...
    SC_CTOR(deconv_layer3_kerKfY) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        deconv_layer3_kerKfY_memcore_U = new deconv_layer3_kerKfY_memcore("deconv_layer3_kerKfY_memcore_U");
        deconv_layer3_kerKfY_memcore_U->clk      ( clk );
        deconv_layer3_kerKfY_memcore_U->reset    ( reset );
        deconv_layer3_kerKfY_memcore_U->ce0      ( i_ce0 );
        deconv_layer3_kerKfY_memcore_U->we0      ( i_we0 );
        deconv_layer3_kerKfY_memcore_U->address0 ( memcore_iaddr );
        deconv_layer3_kerKfY_memcore_U->d0       ( i_d0 );
        deconv_layer3_kerKfY_memcore_U->q0       ( i_q0 );

        deconv_layer3_kerKfY_memcore_U->ce1      ( t_ce0 );
        deconv_layer3_kerKfY_memcore_U->we1      ( t_we0 );
        deconv_layer3_kerKfY_memcore_U->address1 ( memcore_taddr );
        deconv_layer3_kerKfY_memcore_U->d1       ( t_d0 );
        deconv_layer3_kerKfY_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "deconv_layer3_kerKfY.trace");
            // ports
