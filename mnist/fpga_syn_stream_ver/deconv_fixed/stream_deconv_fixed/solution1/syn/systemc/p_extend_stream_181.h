...
#ifndef _p_extend_stream_181_HH_
#define _p_extend_stream_181_HH_
...
struct p_extend_stream_181 : public sc_module {
    ...
    // Module declarations
    p_extend_stream_181(sc_module_name name);
    SC_HAS_PROCESS(p_extend_stream_181);
    ...
    sc_signal< sc_lv<1> > exitcond1_reg_794;
    ...
    sc_signal< sc_lv<5> > tmp_221_fu_285_p1;
    sc_signal< sc_lv<5> > tmp_221_reg_790;
    ...
    sc_signal< sc_lv<18> > tmp_V_93_fu_110;
    sc_signal< sc_lv<18> > tmp_V_92_fu_114;
    sc_signal< sc_lv<18> > tmp_V_91_fu_118;
    sc_signal< sc_lv<18> > tmp_V_90_fu_122;
    sc_signal< sc_lv<18> > tmp_V_89_fu_126;
    sc_signal< sc_lv<18> > tmp_V_88_fu_130;
    sc_signal< sc_lv<18> > tmp_V_87_fu_134;
    sc_signal< sc_lv<18> > tmp_V_86_fu_138;
    sc_signal< sc_lv<18> > tmp_V_85_fu_142;
    sc_signal< sc_lv<18> > tmp_V_84_fu_146;
    sc_signal< sc_lv<18> > tmp_V_83_fu_150;
    sc_signal< sc_lv<18> > tmp_V_82_fu_154;
    sc_signal< sc_lv<18> > tmp_V_81_fu_158;
    sc_signal< sc_lv<18> > tmp_V_80_fu_162;
    sc_signal< sc_lv<18> > tmp_V_79_fu_166;
    sc_signal< sc_lv<18> > tmp_V_78_fu_170;
    sc_signal< sc_lv<18> > tmp_V_77_fu_174;
    sc_signal< sc_lv<18> > tmp_V_76_fu_178;
    sc_signal< sc_lv<18> > tmp_V_75_fu_182;
    sc_signal< sc_lv<18> > tmp_V_74_fu_186;
    sc_signal< sc_lv<18> > tmp_V_73_fu_190;
    sc_signal< sc_lv<18> > tmp_V_72_fu_194;
    sc_signal< sc_lv<18> > tmp_V_71_fu_198;
    sc_signal< sc_lv<18> > tmp_V_70_fu_202;
    sc_signal< sc_lv<18> > tmp_V_69_fu_206;
    sc_signal< sc_lv<18> > tmp_V_68_fu_210;
    sc_signal< sc_lv<18> > tmp_V_67_fu_214;
    sc_signal< sc_lv<18> > tmp_V_66_fu_218;
    sc_signal< sc_lv<18> > tmp_V_65_fu_222;
    sc_signal< sc_lv<18> > tmp_V_64_fu_226;
    sc_signal< sc_lv<18> > tmp_V_63_fu_230;
    sc_signal< sc_lv<18> > tmp_V_95_fu_234;
