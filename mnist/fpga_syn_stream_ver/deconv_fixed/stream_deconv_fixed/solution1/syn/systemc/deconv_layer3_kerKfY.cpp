...
void deconv_layer3_kerKfY::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void deconv_layer3_kerKfY::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void deconv_layer3_kerKfY::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void deconv_layer3_kerKfY::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
