...
#ifndef _p_extend_stream_1_1_HH_
#define _p_extend_stream_1_1_HH_
...
struct p_extend_stream_1_1 : public sc_module {
    ...
    // Module declarations
    p_extend_stream_1_1(sc_module_name name);
    SC_HAS_PROCESS(p_extend_stream_1_1);
    ...
    sc_signal< sc_lv<1> > exitcond2_reg_794;
    ...
    sc_signal< sc_lv<5> > tmp_222_fu_285_p1;
    sc_signal< sc_lv<5> > tmp_222_reg_790;
    ...
    sc_signal< sc_lv<18> > tmp_V_123_fu_114;
    sc_signal< sc_lv<18> > tmp_V_122_fu_118;
    sc_signal< sc_lv<18> > tmp_V_121_fu_122;
    sc_signal< sc_lv<18> > tmp_V_120_fu_126;
    sc_signal< sc_lv<18> > tmp_V_119_fu_130;
    sc_signal< sc_lv<18> > tmp_V_118_fu_134;
    sc_signal< sc_lv<18> > tmp_V_117_fu_138;
    sc_signal< sc_lv<18> > tmp_V_116_fu_142;
    sc_signal< sc_lv<18> > tmp_V_115_fu_146;
    sc_signal< sc_lv<18> > tmp_V_114_fu_150;
    sc_signal< sc_lv<18> > tmp_V_113_fu_154;
    sc_signal< sc_lv<18> > tmp_V_112_fu_158;
    sc_signal< sc_lv<18> > tmp_V_111_fu_162;
    sc_signal< sc_lv<18> > tmp_V_110_fu_166;
    sc_signal< sc_lv<18> > tmp_V_109_fu_170;
    sc_signal< sc_lv<18> > tmp_V_108_fu_174;
    sc_signal< sc_lv<18> > tmp_V_107_fu_178;
    sc_signal< sc_lv<18> > tmp_V_106_fu_182;
    sc_signal< sc_lv<18> > tmp_V_105_fu_186;
    sc_signal< sc_lv<18> > tmp_V_104_fu_190;
    sc_signal< sc_lv<18> > tmp_V_103_fu_194;
    sc_signal< sc_lv<18> > tmp_V_102_fu_198;
    sc_signal< sc_lv<18> > tmp_V_101_fu_202;
    sc_signal< sc_lv<18> > tmp_V_100_fu_206;
    sc_signal< sc_lv<18> > tmp_V_99_fu_210;
    sc_signal< sc_lv<18> > tmp_V_98_fu_214;
    sc_signal< sc_lv<18> > tmp_V_97_fu_218;
    sc_signal< sc_lv<18> > tmp_V_96_fu_222;
    sc_signal< sc_lv<18> > tmp_V_95_fu_226;
    sc_signal< sc_lv<18> > tmp_V_94_fu_230;
    sc_signal< sc_lv<18> > tmp_V_124_fu_234;
