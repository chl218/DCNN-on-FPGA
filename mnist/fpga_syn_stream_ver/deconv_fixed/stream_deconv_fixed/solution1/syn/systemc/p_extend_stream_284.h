...
#ifndef _p_extend_stream_284_HH_
#define _p_extend_stream_284_HH_
...
struct p_extend_stream_284 : public sc_module {
    ...
    // Module declarations
    p_extend_stream_284(sc_module_name name);
    SC_HAS_PROCESS(p_extend_stream_284);
    ...
    sc_signal< sc_lv<1> > exitcond8_reg_798;
    ...
    sc_signal< sc_lv<5> > tmp_219_fu_289_p1;
    sc_signal< sc_lv<5> > tmp_219_reg_794;
    sc_signal< sc_lv<1> > exitcond8_fu_453_p2;
    ...
    sc_signal< sc_lv<18> > tmp_V_31_fu_114;
    sc_signal< sc_lv<18> > tmp_V_30_fu_118;
    sc_signal< sc_lv<18> > tmp_V_29_fu_122;
    sc_signal< sc_lv<18> > tmp_V_28_fu_126;
    sc_signal< sc_lv<18> > tmp_V_27_fu_130;
    sc_signal< sc_lv<18> > tmp_V_26_fu_134;
    sc_signal< sc_lv<18> > tmp_V_25_fu_138;
    sc_signal< sc_lv<18> > tmp_V_24_fu_142;
    sc_signal< sc_lv<18> > tmp_V_23_fu_146;
    sc_signal< sc_lv<18> > tmp_V_22_fu_150;
    sc_signal< sc_lv<18> > tmp_V_21_fu_154;
    sc_signal< sc_lv<18> > tmp_V_20_fu_158;
    sc_signal< sc_lv<18> > tmp_V_19_fu_162;
    sc_signal< sc_lv<18> > tmp_V_18_fu_166;
    sc_signal< sc_lv<18> > tmp_V_17_fu_170;
    sc_signal< sc_lv<18> > tmp_V_16_fu_174;
    sc_signal< sc_lv<18> > tmp_V_15_fu_178;
    sc_signal< sc_lv<18> > tmp_V_14_fu_182;
    sc_signal< sc_lv<18> > tmp_V_13_fu_186;
    sc_signal< sc_lv<18> > tmp_V_12_fu_190;
    sc_signal< sc_lv<18> > tmp_V_11_fu_194;
    sc_signal< sc_lv<18> > tmp_V_10_fu_198;
    sc_signal< sc_lv<18> > tmp_V_9_fu_202;
    sc_signal< sc_lv<18> > tmp_V_8_fu_206;
    sc_signal< sc_lv<18> > tmp_V_7_fu_210;
    sc_signal< sc_lv<18> > tmp_V_6_fu_214;
    sc_signal< sc_lv<18> > tmp_V_5_fu_218;
    sc_signal< sc_lv<18> > tmp_V_4_fu_222;
    sc_signal< sc_lv<18> > tmp_V_3_fu_226;
    sc_signal< sc_lv<18> > tmp_V_2_fu_230;
    sc_signal< sc_lv<18> > tmp_V_1_fu_234;
    sc_signal< sc_lv<18> > tmp_V_33_fu_238;
    ...
    void thread_exitcond8_fu_453_p2();
