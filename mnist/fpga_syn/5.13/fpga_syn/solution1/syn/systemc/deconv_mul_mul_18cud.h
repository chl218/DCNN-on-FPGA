...
#ifndef __deconv_mul_mul_18cud__HH__
#define __deconv_mul_mul_18cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(deconv_mul_mul_18cud) {
    ...
    SC_CTOR(deconv_mul_mul_18cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
