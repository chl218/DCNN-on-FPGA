...
#ifndef __deconv_sdiv_30ns_bkb__HH__
#define __deconv_sdiv_30ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(deconv_sdiv_30ns_bkb) {
    ...
    SC_CTOR(deconv_sdiv_30ns_bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
