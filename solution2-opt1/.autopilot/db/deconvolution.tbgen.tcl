...
set C_modelArgList {
	{ kernel_V int 8 regular {array 1152 { 1 1 } 1 1 }  }
	{ ifeat_V int 8 regular {array 2048 { 1 3 } 1 1 }  }
	{ ofeat_V int 8 regular {array 5184 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ kernel_V_address1 sc_out sc_lv 11 signal 0 } 
	{ kernel_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ kernel_V_q1 sc_in sc_lv 8 signal 0 } 
	...
	{ ofeat_V_address1 sc_out sc_lv 13 signal 2 } 
	{ ofeat_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ ofeat_V_we1 sc_out sc_logic 1 signal 2 } 
	{ ofeat_V_d1 sc_out sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "kernel_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "kernel_V", "role": "address1" }} , 
 	{ "name": "kernel_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "kernel_V", "role": "ce1" }} , 
 	{ "name": "kernel_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "kernel_V", "role": "q1" }} , 
 	...
 	{ "name": "ofeat_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "ofeat_V", "role": "address1" }} , 
 	{ "name": "ofeat_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ofeat_V", "role": "ce1" }} , 
 	{ "name": "ofeat_V_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ofeat_V", "role": "we1" }} , 
 	{ "name": "ofeat_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "ofeat_V", "role": "d1" }}  ]}
...
set ArgLastReadFirstWriteLatency {
	deconvolution {
		kernel_V {Type I LastRead 8 FirstWrite -1}
		ifeat_V {Type I LastRead 3 FirstWrite -1}
		ofeat_V {Type O LastRead -1 FirstWrite 5}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "172289", "Max" : "172289"}
	, {"Name" : "Interval", "Min" : "172290", "Max" : "172290"}
]}
...
set Spec2ImplPortList { 
	kernel_V { ap_memory {  { kernel_V_address0 mem_address 1 11 }  { kernel_V_ce0 mem_ce 1 1 }  { kernel_V_q0 mem_dout 0 8 }  { kernel_V_address1 mem_address 1 11 }  { kernel_V_ce1 mem_ce 1 1 }  { kernel_V_q1 mem_dout 0 8 } } }
	ifeat_V { ap_memory {  { ifeat_V_address0 mem_address 1 11 }  { ifeat_V_ce0 mem_ce 1 1 }  { ifeat_V_q0 mem_dout 0 8 } } }
	ofeat_V { ap_memory {  { ofeat_V_address0 mem_address 1 13 }  { ofeat_V_ce0 mem_ce 1 1 }  { ofeat_V_we0 mem_we 1 1 }  { ofeat_V_d0 mem_din 1 8 }  { ofeat_V_address1 mem_address 1 13 }  { ofeat_V_ce1 mem_ce 1 1 }  { ofeat_V_we1 mem_we 1 1 }  { ofeat_V_d1 mem_din 1 8 } } }
}
