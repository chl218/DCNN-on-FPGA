...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("kernel_V_address1", 11, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("kernel_V_ce1", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("kernel_V_q1", 8, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("ofeat_V_address1", 13, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("ofeat_V_ce1", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("ofeat_V_we1", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("ofeat_V_d1", 8, hls_out, 2, "ap_memory", "mem_din", 1),
};
